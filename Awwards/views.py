...
#     return (request, "updateProfile.html", {prof:"prof"})
...
def profile(request):
    ...
    owner = current_user
    projects = Post.get_by_user(owner)
    ...
    return render(request, 'registration/updateProfile.html', {"form":form, "projects":projects})
